...
class MyTheme {
  ...
  static const Color accent_color = Color.fromRGBO(0,86,179, 1);
  static const Color accent_color_shadow = Color.fromRGBO(30, 144, 255, 0);
  static Color soft_accent_color = Color.fromRGBO(255, 215, 0, 1);
  static Color splash_screen_color = Color.fromRGBO(0,86,179, 1); // if not sure , use the same color as accent color
